<?php include('teacherAuth.php') ?>

<!DOCTYPE html>
<head>
<title>authentication page</title>
<link rel="stylesheet" type="text/css" href="teacherRegistration.css?v=<?php echo time(); ?>">
		...
		<div class="card">
			<div class="inner-box" id="card">
				<div class="card-front">
					<h1>LOGIN</h1>
					<form method="post" action="teacherregistration.php">
